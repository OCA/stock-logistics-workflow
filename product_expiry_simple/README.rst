...
This module is similar to the official `product_expiry <https://www.odoo.com/apps/modules/10.0/product_expiry/>`_ module, but it is both simpler and better:

* Only one *Expiry Date* field instead of 4 fields (End of Life Date, Best before Date, Removal Date, Alert Date)!
* Use date field instead of datetime fields
...
* List views of production lot and quants not have a color depending on Expiry Date
