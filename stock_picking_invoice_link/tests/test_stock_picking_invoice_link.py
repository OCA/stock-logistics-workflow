        ...
        self.so = self.env["sale.order"].create(
            {
                ...
                "order_line": [
                    (
                        ...
                        0,
                        {
                            "name": prod_order.name,
                            "product_id": prod_order.id,
                            "product_uom_qty": 2,
                            "product_uom": prod_order.uom_id.id,
                    ...
                    (
                        ...
                        0,
                        {
                            ...
                            "product_uom_qty": 2,
                            "product_uom": prod_del.uom_id.id,
                    ...
                    (
                        ...
                        0,
                        {
                            "name": serv_order.name,
                            "product_id": serv_order.id,
                            "product_uom_qty": 2,
                            "product_uom": serv_order.uom_id.id,
