...
class StockMove(models.Model):
    ...
    def _check_tier_review(self):
        ...
        need_validation = not self.picking_id.review_ids and valid_tiers and \
            getattr(self.picking_id, self.picking_id._state_field) in self.picking_id._state_to
        if self.state in self.picking_id._state_to and not self.picking_id.validated and need_validation:
