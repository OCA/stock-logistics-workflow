...
class TestMergeWizard(TransactionCase):
    ...
    def test_wiz_has_todo(self):
        ...
        all_moves = self.all_pickings_partner1.move_ids_without_package
    ...
    def test_wiz_has_todo_mixed_partner(self):
        ...
        all_moves = all_pickings.move_ids_without_package
        # merge and ensure we are left w/ one picking only
        wiz.action_merge()
        remaining_pickings = all_moves.mapped("picking_id")
    ...
    def test_wiz_has_todo_mixed_partner_mixed_carrier(self):
        ...
        self.all_pickings_partner1[0].move_ids_without_package.group_id.carrier_id = self.carrier1
        self.all_pickings_partner1[1].move_ids_without_package.group_id.carrier_id = self.carrier2
        self.all_pickings_partner1[2].move_ids_without_package.group_id.carrier_id = self.carrier2
        ...
        self.all_pickings_partner2[0].move_ids_without_package.group_id.carrier_id = self.carrier1
        self.all_pickings_partner2[1].move_ids_without_package.group_id.carrier_id = self.carrier2
        self.all_pickings_partner2[2].move_ids_without_package.group_id.carrier_id = self.carrier1
