...
class TestGroupByDisabledOnPartner(TestGroupByBase, TransactionCase):
    ...
    def test_cancelling_sale_order1(self):
        ...
        so1_moves = so1.picking_ids.move_ids_without_package
        so2_moves = so2.picking_ids.move_ids_without_package
    ...
    def test_sale_stock_merge_procurement_group(self):
        ...
        self.assertEqual(picking1.group_id, picking1.move_ids_without_package.group_id)
