...
[stock_picking_supplier_ref](stock_picking_supplier_ref/) | 14.0.1.1.0 |  | Adds a supplier reference field inside supplier's pickings and allows search for this reference.
