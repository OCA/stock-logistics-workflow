...
[stock_landed_costs_delivery](stock_landed_costs_delivery/) | 15.0.1.0.0 | [![victoralmau](https://github.com/victoralmau.png?size=30px)](https://github.com/victoralmau) | Stock landed costs delivery
...
[stock_picking_batch_extended](stock_picking_batch_extended/) | 15.0.2.2.1 | [![gurneyalex](https://github.com/gurneyalex.png?size=30px)](https://github.com/gurneyalex) [![carlosdauden](https://github.com/carlosdauden.png?size=30px)](https://github.com/carlosdauden) [![i-vyshnevska](https://github.com/i-vyshnevska.png?size=30px)](https://github.com/i-vyshnevska) | Allows manage a lot of pickings in batch
...
[stock_picking_invoice_link](stock_picking_invoice_link/) | 15.0.1.0.3 |  | Adds link between pickings and invoices
...
[stock_picking_operation_quick_change](stock_picking_operation_quick_change/) | 15.0.1.1.0 |  | Change location of all picking operations
