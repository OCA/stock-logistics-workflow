...
[stock_move_actual_date](stock_move_actual_date/) | 18.0.1.1.0 | <a href='https://github.com/yostashiro'><img src='https://github.com/yostashiro.png' width='32' height='32' style='border-radius:50%;' alt='yostashiro'/></a> <a href='https://github.com/aungkokolin1997'><img src='https://github.com/aungkokolin1997.png' width='32' height='32' style='border-radius:50%;' alt='aungkokolin1997'/></a> | Stock Move Actual Date
[stock_move_auto_assign_auto_release](stock_move_auto_assign_auto_release/) | 18.0.1.1.0 |  | Auto release moves after auto assign
[stock_move_backdating](stock_move_backdating/) | 18.0.1.0.0 |  | Stock Move Backdating
...
[stock_move_line_qty_picked](stock_move_line_qty_picked/) | 18.0.1.4.0 | <a href='https://github.com/grindtildeath'><img src='https://github.com/grindtildeath.png' width='32' height='32' style='border-radius:50%;' alt='grindtildeath'/></a> <a href='https://github.com/jbaudoux'><img src='https://github.com/jbaudoux.png' width='32' height='32' style='border-radius:50%;' alt='jbaudoux'/></a> | Separate quantity picked from the reserved quantity
...
[stock_move_vendor_comment](stock_move_vendor_comment/) | 18.0.1.0.0 |  | Add the vendor comment field to stock move
[stock_no_negative](stock_no_negative/) | 18.0.1.0.2 |  | Disallow negative stock levels by default
[stock_override_procurement](stock_override_procurement/) | 18.0.1.0.0 |  | This technical module allow to override procurement values
[stock_owner_restriction](stock_owner_restriction/) | 18.0.1.0.1 |  | Do not reserve quantity with assigned owner
...
[stock_picking_auto_create_lot](stock_picking_auto_create_lot/) | 18.0.2.0.0 | <a href='https://github.com/sergio-teruel'><img src='https://github.com/sergio-teruel.png' width='32' height='32' style='border-radius:50%;' alt='sergio-teruel'/></a> | Auto create lots for incoming pickings
...
[stock_picking_auto_create_package](stock_picking_auto_create_package/) | 18.0.1.1.0 |  | Put all move lines in packs on validation.
...
[stock_picking_batch_account](stock_picking_batch_account/) | 18.0.1.0.0 | <a href='https://github.com/ernestotejeda'><img src='https://github.com/ernestotejeda.png' width='32' height='32' style='border-radius:50%;' alt='ernestotejeda'/></a> <a href='https://github.com/Andrii9090'><img src='https://github.com/Andrii9090.png' width='32' height='32' style='border-radius:50%;' alt='Andrii9090'/></a> | Generates invoices when batch is set to Done state
[stock_picking_batch_account_sale_type](stock_picking_batch_account_sale_type/) | 18.0.1.0.0 | <a href='https://github.com/ernestotejeda'><img src='https://github.com/ernestotejeda.png' width='32' height='32' style='border-radius:50%;' alt='ernestotejeda'/></a> | Generates invoices when batch is set to Done state
...
[stock_picking_batch_outgoing](stock_picking_batch_outgoing/) | 18.0.1.0.0 | <a href='https://github.com/sergio-teruel'><img src='https://github.com/sergio-teruel.png' width='32' height='32' style='border-radius:50%;' alt='sergio-teruel'/></a> | Allows set on pickings the batch picking from last picking (out)
...
[stock_picking_group_by_partner_by_carrier](stock_picking_group_by_partner_by_carrier/) | 18.0.2.1.0 |  | Stock Picking: group by partner and carrier
...
[stock_picking_immediate_transfer_warning](stock_picking_immediate_transfer_warning/) | 18.0.1.0.0 |  | Warn before processing a reserved transfer when no moves have been explicitly picked.
...
[stock_picking_partner_vat](stock_picking_partner_vat/) | 18.0.1.0.0 |  | This module extends the picking functionality. It allows: * Displaying the partner's VAT on the picking form view. * Displaying the partner's VAT on reports: * Picking Operations * Delivery Slip
...
[stock_picking_restrict_cancel_with_orig_move](stock_picking_restrict_cancel_with_orig_move/) | 18.0.1.0.0 |  | Restrict cancellation of dest moves according to origin.
...
[stock_picking_return_empty_package](stock_picking_return_empty_package/) | 18.0.1.0.0 |  | Ensure that only package content is put in stock during a picking return
...
[stock_picking_variable_qty](stock_picking_variable_qty/) | 18.0.1.1.0 | <a href='https://github.com/rafaelbn'><img src='https://github.com/rafaelbn.png' width='32' height='32' style='border-radius:50%;' alt='rafaelbn'/></a> <a href='https://github.com/chienandalu'><img src='https://github.com/chienandalu.png' width='32' height='32' style='border-radius:50%;' alt='chienandalu'/></a> <a href='https://github.com/Andrii9090'><img src='https://github.com/Andrii9090.png' width='32' height='32' style='border-radius:50%;' alt='Andrii9090'/></a> | Handle variable quantity in multi-step deliveries/receptions
...
[stock_scrap_tier_validation](stock_scrap_tier_validation/) | 18.0.1.0.0 |  | Stock Scrap Tier Validation
