...
[stock_move_propagate_first_move](stock_move_propagate_first_move/) | 16.0.1.0.0 |  | This addon propagate the picking type of the original move to all next moves created from procurement
...
[stock_picking_start](stock_picking_start/) | 16.0.1.0.2 |  | Add button to start picking
...
[stock_split_picking](stock_split_picking/) | 16.0.1.0.1 |  | Split a picking in two not transferred pickings
