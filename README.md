...
--- | --- | --- | ---
[product_expiry_simple](product_expiry_simple/) | 10.0.1.0.1 |  | Simpler and better alternative to the official product_expiry module
...
[stock_cancel](stock_cancel/) | 10.0.0.2.0 |  | This module allows you to bring back a completed stock picking to draft state
...
[stock_exclude_to_remove_lot](stock_exclude_to_remove_lot/) | 10.0.1.0.0 | [![rousseldenis](https://github.com/rousseldenis.png?size=30px)](https://github.com/rousseldenis) | This modules allows to exclude lots based on their removal date
...
[stock_no_negative](stock_no_negative/) | 10.0.2.0.0 |  | Disallow negative stock levels by default
[stock_ownership_availability_rules](stock_ownership_availability_rules/) | 10.0.1.0.2 |  | Enforce ownership on stock availability
...
[stock_picking_line_sequence](stock_picking_line_sequence/) | 10.0.1.2.0 |  | Manages the order of stock moves by displaying its sequence
...
[stock_picking_package_preparation_line](stock_picking_package_preparation_line/) | 10.0.1.0.4 |  | Stock Picking Package Preparation Line
...
[stock_quant_package_product_packaging](stock_quant_package_product_packaging/) | 10.0.1.1.1 |  | Use product packagings on packages
[stock_split_picking](stock_split_picking/) | 10.0.2.0.0 |  | Split a picking in two not transferred pickings
