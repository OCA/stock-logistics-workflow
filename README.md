...
[stock_picking_group_by_max_weight](stock_picking_group_by_max_weight/) | 16.0.1.1.0 |  | Allows to filter available pickings for which a maximum weight is not exceeded.
