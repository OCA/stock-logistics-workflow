...
[product_supplierinfo_for_customer_picking](product_supplierinfo_for_customer_picking/) | 14.0.1.0.0 |  | This module makes the product customer code visible in the stock moves of a picking.
