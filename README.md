...
[stock_picking_product_availability_inline](stock_picking_product_availability_inline/) | 13.0.1.1.0 |  | Show product availability in product drop-down in stock picking form view.
