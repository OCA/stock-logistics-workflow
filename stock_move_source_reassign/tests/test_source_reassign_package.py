...
class TestMoveSourceReassignPackage(MoveSourceReassignCommon):
    ...
    def test_move_reassign_action(self):
        ...
        # Check the protection on picking type level
        self.delivery_shop.picking_type_id.can_reassign = False
        with self.assertRaises(ValidationError):
            package_level.action_source_reassign()

        self.delivery_shop.picking_type_id.can_reassign = True
