...
class TestStockValuationLayerUsage(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.stock_picking_type_out_id = cls.env.ref("stock.picking_type_out").id
        cls.stock_picking_type_in_id = cls.env.ref("stock.picking_type_in").id
        ...
        return cls.env["stock.picking"].create(
            {
                ...
                "picking_type_id": cls.stock_picking_type_out_id,
                "location_id": cls.stock_location_id,
                "location_dest_id": cls.stock_location_customer_id,
                "move_lines": [
                    (
                        0,
                        0,
