...
5. Click **Match Selected**.
   ...
   * If the Receipt had a higher quantity than the Bill, Odoo will automatically create a Backorder for the remaining quantity. If you later cancel the backorder and decide not to keep the extra stock, click **Force Matched** on the bill to settle it.
   * If the Bill had a higher quantity, the remaining billed quantity will stay in the view awaiting a future receipt, or you can create a new picking for it using the **Create / Add to Picking** button. If you decide the remaining quantity will never be delivered, you can click **Force Matched** to settle the bill anyway.
