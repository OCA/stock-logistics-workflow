...
class TestPoPropagate(SavepointCase):
    ...
    def test_two_steps(self):
        ...
        internal_picking_products = internal_picking.move_lines.mapped("product_id")
        ...
        self.assertNotIn(self.drumset, internal_picking.move_lines.mapped("product_id"))
        self.env["procurement.group"].run_scheduler()
        self.assertIn(self.drumset, internal_picking.move_lines.mapped("product_id"))
