...
class StockPicking(models.Model):
    ...
    state = fields.Selection(
        ...
        help=" * Draft: not confirmed yet and will not be scheduled until "
        "confirmed.\n"
        " * Waiting Another Operation: waiting for another move to "
        "proceed before it becomes automatically available (e.g. in "
        "Make-To-Order flows).\n"
        " * Waiting: if it is not ready to be sent because the required "
        "products could not be reserved.\n"
        " * Waiting For Payment: waiting for the payment of the related "
        "sale order.\n"
        " * Ready: products are reserved and ready to be sent. If the "
        "shipping policy is 'As soon as possible' this happens as soon "
        "as anything is reserved.\n"
        " * Done: has been processed, can't be modified or cancelled "
        "anymore.\n"
