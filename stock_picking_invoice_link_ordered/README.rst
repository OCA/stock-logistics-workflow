==================================
Stock Picking Invoice Link Ordered
==================================
...
This module depends on stock_picking_invoice_link module adding the
functionality that a link exists when the invoicing policy is set to
quantities ordered.
...
* Create a Sales Order with products with invoicing policy quantities ordered and confirm.
* Create an invoice.
* Deliver the order.
