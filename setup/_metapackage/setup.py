...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo12-addon-stock_move_backdating',
        ...
        'odoo12-addon-stock_picking_filter_product',
        'odoo12-addon-stock_picking_force_assign',
        ...
        'odoo12-addon-stock_picking_product_link',
        ...
        'odoo12-addon-stock_picking_responsible',
