...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-stock_location_validate_inventory>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_move_original_date>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_quant_lock>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_reporting_access>=16.0dev,<16.1dev',
