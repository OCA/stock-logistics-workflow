...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo13-addon-sale_line_returned_qty_mrp',
        ...
        'odoo13-addon-stock_move_change_source_location',
        ...
        'odoo13-addon-stock_picking_import_serial_number',
        ...
        'odoo13-addon-stock_picking_origin_reference',
        'odoo13-addon-stock_picking_origin_reference_purchase',
        'odoo13-addon-stock_picking_origin_reference_sale',
