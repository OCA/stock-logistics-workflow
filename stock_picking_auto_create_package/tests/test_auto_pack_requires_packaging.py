...
class TestAutoPackRequiresPackaging(BaseCommon):
    ...
    def test_01_auto_pack_packages_workflow(self):
        ...
        self.assertEqual(len(picking.move_line_ids.result_package_id), 10)
        ...
        picking.button_validate()
        self.assertEqual(len(picking.move_line_ids.result_package_id), 0)
        ...
        self.assertEqual(len(picking.move_line_ids.result_package_id), 60)
